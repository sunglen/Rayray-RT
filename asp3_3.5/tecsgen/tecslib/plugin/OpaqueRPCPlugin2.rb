...
#   の責任を負わない．
#  
#   $Id: OpaqueRPCPlugin.rb 2780 2018-02-11 11:22:33Z okuma-top $
#++
...
require_tecsgen_lib "lib/GenOpaqueMarshaler2.rb"
require_tecsgen_lib "lib/GenParamCopy.rb"

class OpaqueRPCPlugin2 < ThroughPlugin

  include GenOpaqueMarshaler2
...
#{nest_str}    attribute = C_EXP( "#{@taskAttribute}" );  /* mikan : marshaler task starts at beginning */
#{nest_str}  };
EOT

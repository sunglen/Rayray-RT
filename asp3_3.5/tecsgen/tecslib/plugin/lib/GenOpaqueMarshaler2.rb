...
#   の責任を負わない．
#  
#   $Id: GenOpaqueMarshaler.rb 2780 2018-02-11 11:22:33Z okuma-top $
#++

#== GenOpaqueMarshaler
# OpaqueRPCPlugin, sharedOpaqueRPCPlugin 共通の要素を集めたモジュール
module GenOpaqueMarshaler2
  ...
  RPCPluginArgProc = {
    ...
    "taskAttribute"      => Proc.new { |obj,rhs| obj.set_taskAttribute rhs },
  }
...
# p "substituteAllocator: #{lhs_alloc_cell}.#{lhs_alloc_ent}=>#{rhs_alloc_cell}.#{rhs_alloc_ent}"
  ...
  def initialize_opaque_marshaler
    ...
    @taskPriority = 11
    @taskAttribute = :"TA_ACT"
    @stackSize  = 4096
    @serverChannelCelltype = :"tSocketServer2"
    @clientChannelCelltype = :"tSocketClient2"

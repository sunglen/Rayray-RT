...
#define tSimple_cCall_sayHello( times ) \
	  tOpaqueMarshaler_sSample_eClientEntry_sayHello( \
	   (tOpaqueMarshaler_sSample_IDX)0, (times) )
#define tSimple_cCall_howAreYou( buf, len ) \
	  tOpaqueMarshaler_sSample_eClientEntry_howAreYou( \
	   (tOpaqueMarshaler_sSample_IDX)0, (buf), (len) )

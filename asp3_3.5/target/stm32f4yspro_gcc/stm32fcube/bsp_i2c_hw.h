...
#define HW_I2Cx                                I2C2
#define HW_I2C_RCC_CLK_ENABLE()                __HAL_RCC_I2C2_CLK_ENABLE()
#define HW_I2C_RCC_CLK_DISABLE()               __HAL_RCC_I2C2_CLK_DISABLE()

#define HW_I2C_GPIO_CLK_ENABLE()               __HAL_RCC_GPIOH_CLK_ENABLE()
#define HW_I2C_GPIO_CLK_DISABLE()              __HAL_RCC_GPIOH_CLK_DISABLE()
#define HW_I2C_GPIO_PORT                       GPIOH

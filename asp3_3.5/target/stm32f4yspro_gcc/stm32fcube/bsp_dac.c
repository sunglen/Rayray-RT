...
void BSP_CNCDigital_SetValue(uint16_t dac_value)
{
  /* 设置DAC通道值 */
  HAL_DAC_SetValue(&hdac, DACx_CHANNEL1, DAC_ALIGN_12B_R, dac_value);
  /* 设置DAC通道值 */
  //HAL_DAC_SetValue(&hdac, DACx_CHANNEL2, DAC_ALIGN_12B_R, dac_value);

  /* 启动DAC */
  HAL_DAC_Start(&hdac, DACx_CHANNEL1);

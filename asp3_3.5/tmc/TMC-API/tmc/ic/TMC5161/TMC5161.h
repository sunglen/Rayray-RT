...
u8 tmc5161_reset(TMC5161TypeDef *tmc5161);
u8 tmc5161_restore(TMC5161TypeDef *tmc5161);

/* Sets the values to be used for a reset.
 *     tmc5161:    Your TMC5161 instance
 *     resetState: Array of register reset values (Array size: TMC5161_REGISTER_COUNT)
 */
void tmc5161_register_set_reset_state(TMC5161TypeDef *tmc5161, const int32 *resetState);

/* Register a callback function to be called once a reset or restore is finished.
 *     tmc5161:  Your TMC5161 configuration
 *     callback: The callback function to register
 */
void tmc5161_setCallback(TMC5161TypeDef *tmc5161, tmc5161_callback callback);

/* Periodically call this function. It takes care of reset/restore aswell as differential velocity measurement.
 *     tmc5161: Your TMC5161 instance
 *     tick:    Systick timer value (assumed to be in ms)
 */
void tmc5161_periodicJob(TMC5161TypeDef *tmc5161, uint32 tick);

/* Rotate the motor by a given velocity.
 *     tmc5161:  Your TMC5161 instance
 *     velocity: The velocity to rotate the motor with
 */
void tmc5161_rotate(TMC5161TypeDef *tmc5161, int32 velocity);

/* Rotate the motor by a given velocity to the right.
 *     tmc5161:  Your TMC5161 instance
 *     velocity: The velocity to rotate the motor with
 */
void tmc5161_right(TMC5161TypeDef *tmc5161, uint32 velocity);

/* Rotate the motor by a given velocity to the left.
 *     tmc5161:  Your TMC5161 instance
 *     velocity: The velocity to rotate the motor with
 */
 ...
 *     velocity: The velocity to move the motor with in positioning mode
 */
void tmc5161_moveTo(TMC5161TypeDef *tmc5161, int32 position, uint32 velocity);

/* Move the motor relative to the current position.
 *     tmc5161:  Your TMC5161 instance
 *     ticks:    The distance to move the motor by, relative to the current position.
 *               This value will be updated to absolute target position.
 *     velocity: The velocity to move the motor with in positioning mode
 */

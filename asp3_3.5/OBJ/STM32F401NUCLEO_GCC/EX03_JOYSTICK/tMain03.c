 ...
 *   gen/tMain03_template.c => src/tMain03.c
 ...
 *   uint16_t       cLED_sense( );
 * call port : cJoystick  signature: sJoystick context: task
 *   uint16_t       cJoystick_getState( );
 *
 * #[</PREAMBLE>]# */

/* プロトタイプ宣言や変数の定義をここに書きます */
#include "tMain03_tecsgen.h"
 ...
 * name:         eTaskBody_main
 * global_name:  tMain03_eTaskBody_main
 * oneway:       false
 * #[</ENTRY_FUNC>]# */
void
eTaskBody_main()
